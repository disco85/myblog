#+title: Multithreading console
#+description: My Blog
#+keywords: windows, python
#+options: html-style:nil html-scripts:nil author:nil validate:nil html-allow-html:t toc:nil
#+tags: windows python
#+date: [2020-02-09 Sun 09:06]

* Multithreading console

There are several Unix programs with this feature: user can edit input line since program raise messages to console:
...
It's implementation for Windows is simple:
