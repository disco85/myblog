#+title: Remote debugging in Python
#+description: My Blog
#+keywords: misc, python
#+options: html-style:nil html-scripts:nil author:nil validate:nil html-allow-html:t toc:nil
#+tags: misc python
#+date: [2020-02-04 Tue 06:37]

* Remote debugging in Python

Allows debugging of child subprocesses, author of script is Bertrand Janin.
(Yes, I know that some IDE has own way: PyCharm for example, but this is
IDE-independ way).
