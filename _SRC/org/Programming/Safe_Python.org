...
|------------------------+----------------+----------------+--------------------------+----------------------------------------------|
| mypy                   | Python         | Medium         | Excellent                | Excellent (PEP 484 reference implementation) |
...
| Type checker           | Plugins   | Python version support | IDE integration          | Typical use                      |
|------------------------+-----------+------------------------+--------------------------+----------------------------------|
...
| ty                     | No        | Targets latest Python  | LSP in progress          | Future Ruff ecosystem            |
